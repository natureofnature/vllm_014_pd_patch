...
class AsyncLLM(EngineClient):
    ...
    async def generate(
        ...
        *,
        ...
        try:
            print(f"[ENGINE] generate start: request_id={request_id}")
            ...
            print(f"[ENGINE] generate queued: request_id={request_id}")
            ...
            while not finished:
                ...
                if not saw_first:
                    print(
                        f"[ENGINE] generate first output: request_id={request_id}"
                    )
                    saw_first = True
                yield out
            print(f"[ENGINE] generate done: request_id={request_id}")
