...
class GPUModelRunner(
    ...
    def execute_model(
        ...
        if num_scheduled_tokens > 0:
            ...
            print(
                "[DECODER][MODEL_RUNNER] execute_model enter: "
                f"req_ids={req_ids}, tokens={num_scheduled_tokens}"
            )
        with (
            ...
            if not num_scheduled_tokens:
                ...
                if not has_kv_transfer_group():
                    ...
                    print(
                        "[DECODER][MODEL_RUNNER] execute_model no-op: "
                        "no scheduled tokens"
                    )
    ...
    def sample_tokens(
        ...
        # Guard against any debug logging that references num_scheduled_tokens.
        num_scheduled_tokens = scheduler_output.total_num_scheduled_tokens
        ...
        with record_function_or_nullcontext("gpu_model_runner: ModelRunnerOutput"):
            ...
            if num_scheduled_tokens > 0:
                print(
                    "[DECODER][MODEL_RUNNER] execute_model output ready: "
                    f"req_ids={req_ids_output_copy}"
                )
