...
class OpenAIServingChat(OpenAIServing):
    ...
    async def create_chat_completion(
        ...
        Chat Completion API.
        """
        # Debug log for P/D disaggregation
        print(f"[API] create_chat_completion: model={request.model}, "
              f"kv_transfer_params={getattr(request, 'kv_transfer_params', None)}")
        ...
        # Streaming response
        if request.stream:
            print(f"[API] create_chat_completion: streaming response, request_id={request_id}")
        ...
        try:
            print(f"[API] create_chat_completion: full response start, request_id={request_id}")
            ...
            print(f"[API] create_chat_completion: full response done, request_id={request_id}")
            return response
    ...
    async def chat_completion_full_generator(
        ...
        try:
            saw_first = False
            print(f"[API] chat_completion_full_generator: start result iteration, request_id={request_id}")
            async for res in result_generator:
                if not saw_first:
                    print(f"[API] chat_completion_full_generator: first result received, request_id={request_id}")
                    saw_first = True
                final_res = res
        ...
        print(f"[API] chat_completion_full_generator: final result ready, request_id={request_id}")
